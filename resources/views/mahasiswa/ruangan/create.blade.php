    ...
    <div class="col-md-8 col-md-offset-2">
        ...
        <div id="respon">
            ...
            <div class="panel row">
                ...
                <form action="{{ route('mahasiswa.ruangan.store') }}" method="post" id="form-peminjaman">
                    @csrf
                    {{-- Input Hidden --}}
                ...
                <button type="submit" href="" class="btn btn-primary"><i class="fa fa-save"></i> Simpan</button>
                </div>
